...
// Define the uploads directory path inside "Furry-finder/Form/"
const uploadDir = path.join(__dirname, '../Furry-finder/Form/uploads');
...
app.post('/post', upload, (req, res) => {
    ...
    newPet.save().then(() => {
        res.send('Form submitted and pet details saved to the database.');
    }).catch((error) => {
